...
const WorkHeroSection = ({title, description, image, livesite, slug}:{title: string, description: string, image: string, livesite: string, slug : string}) => {
  return (
      ...
      <Container>
        <div className="h-full relative py-20  ">
          ...
          <div className="flex space-x-3 items-center">
            <Link href={"/works"}  className="uppercase text-sm  text-white/50 ">Works</Link> 
