    ...
    <div className="px-5 lg:px-0 bg-gradient-to-b from-[#000000] overflow-hidden relative to-[#00008B] to-purple-5000 py-20  lg:pt-32 lg:pb-48">
      <Container>
        <div className="lg:w-3/4 mx-auto">
            ...
            <div className="rounded-3xl flex-wrap lg:flex-nowrap border border-white/30 p-9 lg:p-12 xl:px-12 xl:py-20 grid grid-cols-2 lg:grid-cols-4 xl:flex items-center gap-8 xl:space-x-6 w-full mt-8 lg:mt-12 lg:mx-auto">
                <Image width={200} className="w-0px] lg:w-full" height={150} src="/images/client-logo.png" alt="client logo" />
                <Image width={200} className="w-0px] lg:w-full" height={150} src="/images/client-logo.png" alt="client logo" />
                <Image width={200} className="w-0px] lg:w-full" height={150} src="/images/client-logo.png" alt="client logo" />
                <Image width={200} className="w-0px] lg:w-full" height={150} src="/images/client-logo.png" alt="client logo" />
                <Image width={200} className="w-0px] lg:w-full" height={150} src="/images/client-logo.png" alt="client logo" />
